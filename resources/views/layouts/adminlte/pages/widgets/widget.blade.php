        ...
        <div class="col-md-3">
            <div class="card card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools')}}">
                        <button type="button" class="btn btn-tool" data-card-widget="card-refresh" data-source="{{route('welcomex-widgetxx')}}" data-source-selector="#card-refresh-content">
        ...
        <div class="col-md-3">
            <div class="card card-success')}}">
                <div class="card-header">
                    ...
                    <div class="card-tools')}}">
                        <button type="button" class="btn btn-tool" data-card-widget="card-refresh" data-source="{{route('welcomex-widgetxx')}}" data-source-selector="#card-refresh-content" data-load-on-init="false">
                            <i class="fas fa-sync-alt"></i>
                        </button>
