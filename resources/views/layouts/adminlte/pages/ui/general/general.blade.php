...
<div class="container-fluid">
    ...
    <div class="card card-default color-palette-box">
        ...
        <div class="card-body">
            ...
            <!-- /.col-12 -->
            <div class="row">
                @include('layouts.adminlte.pages.ui.general.paleta',['tituloxx'=>'Primary','classxxx'=>'bg-primary','colorxxx'=>'#007bff'])
                
                <!-- /.col -->
                @include('layouts.adminlte.pages.ui.general.paleta',['tituloxx'=>'Secondary','classxxx'=>'bg-secondary','colorxxx'=>'#6c757d'])
                
                <!-- /.col -->
                @include('layouts.adminlte.pages.ui.general.paleta',['tituloxx'=>'Info','classxxx'=>'bg-info','colorxxx'=>'#17a2b8'])
                <!-- /.col -->
