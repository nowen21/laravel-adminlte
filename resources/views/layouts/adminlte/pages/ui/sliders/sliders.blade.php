...
@section('styles')
 <!-- Ion Slider -->
 <link rel="stylesheet" href="{{asset('{{asset('plugins/ion-rangeslider/css/ion.rangeSlider.min.css')}}">
  <!-- bootstrap slider -->
  <link rel="stylesheet" href="{{asset('{{asset('plugins/bootstrap-slider/css/bootstrap-slider.min.css')}}">
@endsection
...
@section('scripts')
@include('layouts.adminlte.pages.ui.sliders.scripts')
@endsection
@endsection