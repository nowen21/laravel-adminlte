...
<div class="row">
    <div class="col-md-3">
        <a href="{{route('welcomex-composex')}}" class="btn btn-primary btn-block mb-3">Compose</a>
                    ...
                    <table class="table table-hover table-striped">
                        <tbody>
                            <tr>
                                ...
                                <td class="mailbox-name"><a href="{{route('welcomex-readxxxx')}}">Alexander Pierce</a></td>
